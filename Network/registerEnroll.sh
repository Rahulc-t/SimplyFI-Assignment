...
function createtreasury() {
  ...
  set -x
  fabric-ca-client register --caname ca-treasury --id.name peer1 --id.secret peer1pw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/treasury/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:8054 --caname ca-treasury -M "${PWD}/organizations/peerOrganizations/treasury.scholar.com/peers/peer1.treasury.scholar.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/treasury/ca-cert.pem"
  { set +x; } 2>/dev/null

  cp "${PWD}/organizations/peerOrganizations/treasury.scholar.com/msp/config.yaml" "${PWD}/organizations/peerOrganizations/treasury.scholar.com/peers/peer1.treasury.scholar.com/msp/config.yaml"

  echo "Generating the peer1-tls certificates, use --csr.hosts to specify Subject Alternative Names"
  set -x
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:8054 --caname ca-treasury -M "${PWD}/organizations/peerOrganizations/treasury.scholar.com/peers/peer1.treasury.scholar.com/tls" --enrollment.profile tls --csr.hosts peer1.treasury.scholar.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/treasury/ca-cert.pem"
  { set +x; } 2>/dev/null

  # Copy the tls CA cert, server cert, server keystore to well known file names in the peer's tls directory that are referenced by peer startup config
  cp "${PWD}/organizations/peerOrganizations/treasury.scholar.com/peers/peer1.treasury.scholar.com/tls/tlscacerts/"* "${PWD}/organizations/peerOrganizations/treasury.scholar.com/peers/peer1.treasury.scholar.com/tls/ca.crt"
  cp "${PWD}/organizations/peerOrganizations/treasury.scholar.com/peers/peer1.treasury.scholar.com/tls/signcerts/"* "${PWD}/organizations/peerOrganizations/treasury.scholar.com/peers/peer1.treasury.scholar.com/tls/server.crt"
  cp "${PWD}/organizations/peerOrganizations/treasury.scholar.com/peers/peer1.treasury.scholar.com/tls/keystore/"* "${PWD}/organizations/peerOrganizations/treasury.scholar.com/peers/peer1.treasury.scholar.com/tls/server.key"
...
function createuniversity() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:10054 --caname ca-university --tls.certfiles "${PWD}/organizations/fabric-ca/university/ca-cert.pem"
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-10054-ca-university.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-10054-ca-university.pem
    OrganizationalUnitIdentifier: peer
  ...
  echo "Generating the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:10054 --caname ca-university -M "${PWD}/organizations/peerOrganizations/university.scholar.com/peers/peer0.university.scholar.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/university/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  echo "Generating the peer0-tls certificates, use --csr.hosts to specify Subject Alternative Names"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:10054 --caname ca-university -M "${PWD}/organizations/peerOrganizations/university.scholar.com/peers/peer0.university.scholar.com/tls" --enrollment.profile tls --csr.hosts peer0.university.scholar.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/university/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  echo "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:10054 --caname ca-university -M "${PWD}/organizations/peerOrganizations/university.scholar.com/users/User1@university.scholar.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/university/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  echo "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://universityadmin:universityadminpw@localhost:10054 --caname ca-university -M "${PWD}/organizations/peerOrganizations/university.scholar.com/users/Admin@university.scholar.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/university/ca-cert.pem"
  { set +x; } 2>/dev/null
...
function createauditor() {
  ...
  echo "Generating the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11054 --caname ca-auditor -M "${PWD}/organizations/peerOrganizations/auditor.scholar.com/peers/peer0.auditor.scholar.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/auditor/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  echo "Generating the peer0-tls certificates, use --csr.hosts to specify Subject Alternative Names"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11054 --caname ca-auditor -M "${PWD}/organizations/peerOrganizations/auditor.scholar.com/peers/peer0.auditor.scholar.com/tls" --enrollment.profile tls --csr.hosts peer0.auditor.scholar.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/auditor/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  echo "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:11054 --caname ca-auditor -M "${PWD}/organizations/peerOrganizations/auditor.scholar.com/users/User1@auditor.scholar.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/auditor/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  echo "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://auditoradmin:auditoradminpw@localhost:11054 --caname ca-auditor -M "${PWD}/organizations/peerOrganizations/auditor.scholar.com/users/Admin@auditor.scholar.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/auditor/ca-cert.pem"
  { set +x; } 2>/dev/null
